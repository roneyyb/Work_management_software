    ...
    return (
      ...
      {(insets) => (
            ...
            <Text style={{fontSize:40, color:'black', fontWeight:'500'}}>
              ...
              <Text style={{ fontSize: 30, color: AppConstant.appColor, fontWeight: '500' }}>
              ...
              <View>
                ...
                <TouchableOpacity
                  ...
                  <Text style={{ color: AppConstant.appColor, fontSize: 30, fontWeight: 'bold', fontFamily:'cursive' }}>{'Next '}</Text>
                </TouchableOpacity>
                </View>
              </View>
                <View
                ...
                <TouchableOpacity
                  ...
                  <Text style={{ color: AppConstant.appColor, fontSize: 15, marginLeft:5, fontWeight: '500', fontWeight:'bold' }}>{'SignUp '}</Text>
                </TouchableOpacity>
                </View>
              </View>
