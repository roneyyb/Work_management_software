...
class Taskshowup extends Component {
  ...
  updatinglocalworklist = (worklistbackend) => {
    this.props.updateWorkListAfterCloud(worklistbackend);
  };
  ...
  renderHeader = () => (
    <View
      style={{ flexDirection: "row", justifyContent: "center", height: 40 }}
    >
  ...
  headerAction = (deleted) => {
    ...
    this.props.undoType(
      [...this.deleteid],
      deleted ? "Deleted" : !completed ? "Completed" : "Incompleted"
    );
    this.callUndo(
      [...this.deleteid],
  ...
  undoaction = async () => {
    ...
    await this.props.giveAllTask(this.props.selectedwork.workid);
  ...
  onSelectingTask = (taskid, flipped) => {
    if (flipped) {
      ...
      if (this.deleteid.length === 1) {
        ...
        this.setTaskTouch(true);
      } else if (this.deleteid.length > 1) {
    ...
    return (
      ...
      >
            ...
            renderItem={({ item, index }) => {
              return (
                <Taskeach
                  ...
                  last={tasklistlength}
                  onSelectingTask={this.onSelectingTask}
                  taskTouchDisable={this.state.taskTouchDisable}
        ...
        <Header
          ...
          setTaskTouch={this.setTaskTouch}
        />
        ...
        >
          <Animated.Text style={[styles.undoCountText, { opacity: undosize }]}>
